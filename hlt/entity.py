...
class Entity:
    ...
    def calculate_distance_between(self, target):
        ...
        pt/ calcula a distrancia entre o objeto e o alvo(target)
        """
    ...
    def calculate_angle_between(self, target):
        ...
        pt/ calcula o angulo entre o objeto e o alvo em graus
        """
    ...
    def closest_point_to(self, target, min_distance=3):
        ...
        pt/ Encontre o ponto mais próximo de um determinado
         navio perto de determinado alvo, fora de seu raio fornecido,
        """
...
class Planet(Entity):
    ...
    def get_docked_ship(self, ship_id):
        ...
        /devolve o navio atracado designado por seu id
        """
    ...
    def all_docked_ships(self):
        ...
        pt/ lista de todas as naves ancoradas no planeta
        """
    ...
    def is_full(self):
        ...
        :rtype: bool
        pt/ Determina se o planeta foi totalmente ocupado 
        (todas as naves possíveis estão ancoradas)
        """
...
class Ship(Entity):
    ...
    def thrust(self, magnitude, angle):
        ...
        pt/ Gere um comando para acelerar esta nave. 
        """
    ...
    def dock(self, planet):
        ...
        pt/Gere um comando para acoplar a um planeta. 
        """
    ...
    def can_dock(self, planet):
        ...
        pt/Determine se uma nave pode atracar em um planeta 
        """
